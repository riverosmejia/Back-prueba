...
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 90, unique: false, nullable: false }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => User_1.User, { nullable: true }) // Hacer que la relación sea opcional
    ,
